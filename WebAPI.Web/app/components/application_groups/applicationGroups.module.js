    ...
    function config($stateProvider, $urlRouterProvider) {
        $stateProvider
            ...
            .state('add_application_group', { //khai báo cho đường dẫn admin và dùng controller
                url: "/add_application_group",//trỏ tới url này thì nó chuyển vào view html bên dưới
            ...
            .state('edit_application_group', { //khai báo cho đường dẫn admin và dùng controller
                url: "/edit_application_group/:id",//trỏ tới url này thì nó chuyển vào view html bên dưới
